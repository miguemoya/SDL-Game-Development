...
bool Game::init(const char* title, int xpos, int ypos, int width, int height, bool fullscreen)
{
    ...
    //SDL_QueryTexture(m_pTexture, NULL, NULL, &m_sourceRectangle.w, &m_sourceRectangle.h);  // no obtenemos las dimensiones del fichero de sprites

    m_sourceRectangle.w = 128;  // establecemos manualmente las dimensiones de un sprite del fichero
