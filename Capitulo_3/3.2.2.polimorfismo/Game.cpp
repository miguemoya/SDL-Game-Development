...
bool Game::init(const char* title, int xpos, int ypos, int width, int height, bool fullscreen)
{
    ...
    // m_enemy2->load(200, 200, 128, 82, "animate");
    // m_enemy3->load(400, 400, 128, 82, "animate");
...
void Game::draw()
{
    ...
    // aun siendo un puntero a la clase base GameObject, se ejecutará la función draw de Enemy y Player
    for(std::vector<GameObject*>::size_type i = 0; i != m_gameObjects.size(); i++)
    {
        m_gameObjects[i]->draw(m_pRenderer);
    }
